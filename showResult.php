<?php
	...
	if(!isset($_POST['action']) || $_POST['action'] != 'Ausblenden')
	{
		...
		if($unusedClasses != "<ul></ul>")//<ul> is automatically generated by formatter
		{
		...
		if($missingparticipations != "<ul></ul>")//<ul> is automatically generated by formatter
		{
...
@media print
{
.resulttable {page-break-inside:avoid}
